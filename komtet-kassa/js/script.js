 /*
  * Модуль komtetKassaModule, подключается на странице настроек плагина.
  * Скрипт будет запущен только тогда, когда страница админки будет готова к выводу настроек плагина.
  */
        ...
        $.ajax({
          ...
          data: {
            ...
            data:{
              ...
              is_print : $(".base-settings-open input[name=is_print]").val(),
